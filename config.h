...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_BackSpace,	spawn,		SHCMD("dmenupower") },
	...
	{ MODKEY,			XK_x,		spawn,		SHCMD("xset s activate; sleep 1; xset dpms force off; mpc pause; pauseallmpv") },
	...
	{ 0,	XF86XK_PowerOff,	spawn,		SHCMD("dmenupower") },
	{ 0,	XF86XK_Calculator,	spawn,		SHCMD("st -e bc -l") },
	{ 0,	XF86XK_Sleep,		spawn,		SHCMD("prompt \"Hibernate computer?\" \"sudo -A zzz -Z\"") },
	{ 0,	XF86XK_WWW,		spawn,		SHCMD("$BROWSER") },
	{ 0,	XF86XK_DOS,		spawn,		SHCMD("st") },
	{ 0,	XF86XK_ScreenSaver,	spawn,		SHCMD("xset s activate; sleep 1; xset dpms force off; mpc pause; pauseallmpv") },
